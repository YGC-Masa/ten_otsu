...
(function(){
  ...
  ns.ensureLayers = function ensureLayers() {
    ...
    layers.version = el("div", { className: "tenotsu-version-badge", text: ns.VERSION || "v039_42" }, app);
  ...
  ns.showStorySurfaceProbe = function showStorySurfaceProbe(reason) {
    ...
    layers.storyDebug.innerHTML = `
      <div class="probe-label probe-label-main">SURFACE PROBE v039_42: ${reason || "active"}</div>
