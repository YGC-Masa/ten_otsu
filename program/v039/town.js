/* v039_37 town season event tree */
(function(){
  "use strict";
  ...
  ns.renderTownSeasonTop = function renderTownSeasonTop() {
    ...
    const html = `
      ...
      <div class="tenotsu-town-subtitle">季節・その他・イベントを選んで、対象イベントを確認します。</div>
  ...
  ns.renderSeasonEvents = async function renderSeasonEvents(seasonId, options = {}) {
    ...
    const selectEvent = (eventId) => {
      ...
      // v039_37: event summary is shown in detail panel; bottom text is hidden in town mode.
