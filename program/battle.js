...
const battleBackgrounds = {
  ...
  function onStaffDoubleTap(staffId) {
    ...
    if (s.skill < 100) {
      // v037_92: ダブルタップ時に必殺不可でも、通常接客が可能なら通常クリックとして処理する
  ...
  function handleHelpClick(event) {
    ...
    // v037_92: 乱連打前提。押せるなら即発動、連打による多重発動だけ短時間ロック。
...
/* v037_92 office return after battle hide */
(function(){
