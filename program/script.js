window.TENOTSU_LATEST_VERSION = "v038_17";

/* v037_85 engine guard: 起動停止対策 */
window.TENOTSU_ENGINE_VERSION = "v038_17";
...
function tenotsuEnterOfficeMode(reason = "office") {
  try {
    ...
    // v038_17: 事務所へ戻るたびにランダム立ち絵/コメントを再抽選するため、ここではOFFにしない。
    clearCharacters();
...
/* v038_17: タイトル/事務所共通ランダム立ち絵＋コメント */
...
window.TENOTSU_BOOT_FLOW_VERSION = "v038_17";
...
function tenotsuRunBootFlow() {
  ...
  try {
    ...
    if (bootVersion) bootVersion.textContent = window.TENOTSU_BOOT_FLOW_VERSION || "v038_17";
...
function tenotsuHandleStoryEndReturn() {
  ...
  window.setTimeout(() => {
    // v038_17: 「物語は つづく・・・」後、1秒かけてゆっくりブラックフェード。
...
/* v038_17 office/menu/character stability patch */
(function(){
...
/* v038_17 office character actual-path patch */
(function(){
...
/* v038_17 exchange shop background + office character z-index fix */
(function(){
...
/* v038_17 office return background + 3-character positioning fix */
(function(){
...
/* v038_17 office foreground overlay + shop greeting + shop left-menu guard */
(function(){
  const OFFICE_BG = "images/assets/bgev/bg_office_hidamari.png";
...
/* v038_17 Sakuya exchange intro implementation */
(function(){
...
/* v038_17 runtime layer/click/character fix */
(function(){
...
/* v038_17 office no-background test build */
(function(){
...
/* v038_17 office background direct filename detection */
(function(){
  const TRANSPARENT_PIXEL = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";
...
/* v038_17 office forced foreground diagnostic render */
(function(){
