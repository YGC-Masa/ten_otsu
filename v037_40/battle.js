...
(function () {
  ...
  const staffMaster = [
    ...
    { id: "am", name: "萌", color: "#33CC99", attr: "リラックス", power: 1, ctMax: 2.9, skillName: "おにいちゃん助けて", skillType: "managerBoost", skillDesc: "店長ヘルプゲージが溜まりやすくなるサポートスキル。" }
  ...
  function onStaffDoubleTap(staffId) {
    ...
    if (s.skill < 100) {
      // v037_40: ダブルタップ時に必殺不可でも、通常接客が可能なら通常クリックとして処理する
  ...
  function handleHelpClick(event) {
    ...
    // v037_40: 乱連打前提。押せるなら即発動、連打による多重発動だけ短時間ロック。
